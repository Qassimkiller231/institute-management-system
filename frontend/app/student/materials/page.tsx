...
import { getToken, isAuthenticated, getUserRole, getStudentId } from '@/lib/authStorage';
import { studentsAPI, materialsAPI } from '@/lib/api';
...
export default function StudentMaterialsPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Get student's enrollments to get groupIds
      ...
      for (const enrollment of activeEnrollments) {
        const materialsRes = await materialsAPI.getByGroup(enrollment.groupId);
