...
export default function StudentPaymentsPage() {
  ...
  const remaining = paymentPlan ? parseFloat(paymentPlan.finalAmount) - totalPaid : 0;
  const progressPercentage = paymentPlan ? (totalPaid / parseFloat(paymentPlan.finalAmount)) * 100 : 0;
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {installments
                ...
                .map((installment) => renderInstallmentRow(installment))}
            </tbody>
          </table>
        </div>
      </div>
  ...
  /**
   * Render restricted access state
   */
