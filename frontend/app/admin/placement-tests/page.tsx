...
export default function PlacementTestsPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Placement Tests</h1>
        <p className="text-gray-700">Manage student placement test sessions and results</p>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-purple-600">
          <p className="text-sm font-medium text-gray-700 mb-1">Avg Score</p>
                ...
                <td className="px-6 py-4">
                  {test.status === 'IN_PROGRESS' ? (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-gray-900">{test.progress}%</span>
                    </div>
                  ) : (
                    <span className="text-sm text-center text-gray-900">-</span>
                  )}
                </td>
