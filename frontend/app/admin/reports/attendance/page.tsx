  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-700">Generate and view attendance reports by group</p>
      </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setSelectedGroup(''); // Reset group when program changes
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900">
              Attendance Report - {reportData.groupCode}
            </h2>
            <button 
              onClick={exportPDF}
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded">
              ...
              <p className="text-3xl font-bold text-gray-900">{reportData.totalSessions}</p>
            </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {reportData.students.map((student: any, idx: number) => (
                  <tr key={idx} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center text-sm text-gray-900">{student.present}</td>
                    <td className="px-6 py-4 text-center text-sm text-gray-900">{student.absent}</td>
                    <td className="px-6 py-4 text-center text-sm text-gray-900">{student.late}</td>
      ...
      {!reportData && !loading && (
        <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
          <p className="text-gray-600 text-lg">Select a group and click "Generate Report" to view attendance data</p>
        </div>
      )}
    </div>
  );
