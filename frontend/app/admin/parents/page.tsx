              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredParents.map((parent) => (
                  <tr key={parent.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {parent._count?.parentStudentLinks || 0}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                      ...
                      <button
                        onClick={() => openLinkStudentModal(parent)}
                      ...
                      {parent.user.isActive ? (
                        <button
                          onClick={() => handleDelete(parent.id, parent.firstName)}
                        ...
                        <button
                          onClick={() => handleReactivate(parent.id, parent.firstName)}
                          className="text-green-600 hover:text-green-800"
                        >
                          Reactivate
                        </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <h2 className="text-2xl font-bold mb-6">
              {modalMode === 'create' && 'Add New Parent'}
              {modalMode === 'edit' && 'Edit Parent'}
              {modalMode === 'linkStudent' && 'Link Student to Parent'}
            </h2>

            {modalMode === 'linkStudent' ? (
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Student *</label>
                  <select
                    value={linkStudentData.studentId}
                    onChange={(e) => setLinkStudentData({ ...linkStudentData, studentId: e.target.value })}
                  ...
                  >
                    ...
                    {students.map(student => (
                      <option key={student.id} value={student.id}>
                        {student.firstName} {student.secondName} {student.thirdName} - {student.cpr}
                      </option>
                    ))}
                  </select>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={linkStudentData.relationship}
                    onChange={(e) => setLinkStudentData({ ...linkStudentData, relationship: e.target.value })}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                  />
                  <p className="text-xs text-gray-600 mt-1">Can share email with student</p>
                </div>
                ...
                <div className="mt-6 flex space-x-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
                  >
                    {modalMode === 'create' ? 'Create Parent' : 'Update Parent'}
                  </button>
                </div>
              </div>
            )}
