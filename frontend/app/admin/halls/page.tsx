          ...
          <div className="bg-white rounded-lg p-8 max-w-md w-full">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={modalMode === 'create' ? formData.venueId : (editData.venueId || '')}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Hall Code *</label>
                <input
                  type="text"
              ...
              <div>
                ...
                <input
                  type="number"
                  value={modalMode === 'create' ? formData.capacity : (editData.capacity || 0)}
                  onChange={(e) => modalMode === 'create'
