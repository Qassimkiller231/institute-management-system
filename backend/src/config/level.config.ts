...
// Replicated from frontend/lib/levelConfig.ts for backend consistency
...
// Configuration for 5-question tests (1 point per level)
export const FIVE_QUESTION_LEVEL_CONFIG: TestLevelConfig = {
    totalQuestions: 5,
    levelRanges: [
        { range: [0, 0], value: "A1" },   // 0
        { range: [1, 1], value: "A2" },   // 1
        { range: [2, 2], value: "B1" },   // 2
        { range: [3, 3], value: "B2" },   // 3
        { range: [4, 4], value: "C1" },   // 4
        { range: [5, 5], value: "C2" },   // 5
    ]
};
